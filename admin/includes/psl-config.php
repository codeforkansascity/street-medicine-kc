...
define("USER", "homeless_kc"); // The database username.
define("PASSWORD", "kiran-0605"); // The database password.
define("DATABASE", "homeless_kc"); // The database name.
 ...
 *      admin == admin must be registered by an administrator
 *      root  == only the root user can register admin
 *
